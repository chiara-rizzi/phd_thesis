...
this is used to estimate the uncertainty on the luminosity due to the extrapolation between 
...
Grouping together several \glspl{lub} is necessary to accumulate enough statistics: the frequency of laser pulses is 3 Hz, 
...
as long as it is large enough to provide sufficient statistics.
...
\begin{description}
\item[\gls{vdm} calibration] The uncertainty on the \gls{vdm} calibration results from uncertainties on the 
