...
\caption{Ratio of the luminosity measured by LUCID (red) and TileCal (black) to the track luminosity as a function of $\mu$.}
...
integrator system of the TileCal detector, and the relative difference between the luminosity measured by the tracking system and 
by TileCal is used as uncertainty. 
Just like in the case of the luminosity measurement from the tracking system, the TileCal luminosity measurement 
