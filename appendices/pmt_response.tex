...
The \gls{tilecal} laser system is designed with the main purpose of calibrating the \glspl{pmt} and readout chain, and 
it has been renewed for Run 2. 
...
3 Hz. 
This procedure is used to detect "time jumps" 
...
It has previously been noticed (e.g. Ref. \cite{giulia:tesi}) that the \gls{tilecal} \glspl{pmt} show a non-linearity in 
