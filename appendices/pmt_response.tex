...
The average relative difference between \gls{tilecal} and tracks results to be:
\begin{description}
...
that the inclusion of the laser corrections reduces the uncertainty by about 1\%.
...
\nointend The numerical value for the laser correction used is the one labeled as "average" in Figures \ref{fig:apppmt:331085:variation_A13}
