...
\begin{figure}[htbp]
\centering
\subfigure{\includegraphics[width=0.47\textwidth]{figures/pmt_response/scan_to_scan.pdf}\label{fig:app:scantoscan}}
\subfigure{\includegraphics[width=0.47\textwidth]{figures/pmt_response/long_term_stability.pdf}\label{fig:app:longterm}}
