...
The post-fit data-\gls{mc} agreement in the \glspl{vr} is shown in Figure \ref{fig:pullVR}: the top panel of this figure 
...
Note that this is different from the pull definition adopted in Figure \ref{fig:pullCR}. 
