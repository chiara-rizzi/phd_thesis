...
high-\pt region, $J/\Psi \rightarrow e e$ and minimum bias events for the low-\pt region.

The signal and background samples are used to build \gls{pdf} for each discriminating variable, whose product constitutes the 
