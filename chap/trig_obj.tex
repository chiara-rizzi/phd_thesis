...
\begin{table}[h]
\begin{center}
    \includegraphics[width=0.99\textwidth]{figures/objects/ele_var_tab.pdf}  
\end{center}
...
Three identification \glspl{op} are defined, Loose, Medium and Tight, that are inclusive and with an increasing level of signal purity. 
