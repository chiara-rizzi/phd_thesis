...
$B$-tagged jets are identified by high values of a likelihood discriminant, 
...
and all the inefficiency \glspl{sf} for the jets that are not $b$-tagged. Several techniques are used in \gls{atlas} to measure the $b$-tagging 
