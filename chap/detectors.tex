...
\end{equation}
and 25 radiation lengths contain about 99\% of the total shower energy. The typical values for the interaction length are of the order of the $cm$ (e.g. 0.56 cm for lead \cite{Patrignani:2016xqp}), allowing for electromagnetic calorimeters of compact dimensions. 
The lateral with of the shower increases with depth and is defined in terms of the Moli\'ere radius:
\begin{equation}
R_M = \frac{21 MeV \; X_0[\frac{g}{cm^2}]}{E_c [MeV]} \; .
\end{equation}
A cylinder of radius 2$R_M$ contains about 95\% of the shower. The longitudinal and lateral development of the shower induced in lead by 6-GeV electrons is shown in Fig. \ref{fig:det:shower_elec}(b).
