...
%  \subfigure[]{
%    \label{fig:Comb_syst:pt}
%    \includegraphics[width=0.48\textwidth]{figures/Chap4/Rizzi-Fig4-2-1.pdf}
%  }
%    \subfigure[]{
%    \label{fig:Comb_syst:pt}
%    \includegraphics[width=0.48\textwidth]{figures/Chap4/Rizzi-Fig4-2-2.pdf}
%  }
%\end{center}
...
%\begin{center}
%  \subfigure[]{
%    \includegraphics[width=0.35\textwidth]{figures/Chap4/Rizzi-Fig4-4-1.pdf}
 %       \label{fig:string_model}
%  }
%    \subfigure[]{
 %   \includegraphics[width=0.35\textwidth]{figures/Chap4/Rizzi-Fig4-4-2.pdf}
