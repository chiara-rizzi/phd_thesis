...
\centering 
%\subfigure[]{
\includegraphics[width=0.70\textwidth]{figures/strong_prod/diagrams/XSectionPlots_13TeV_Gluino_decouplingLimit_xsec_gg_200_3050.pdf}
%\label{fig:}}
...
\end{itemize}
After selecting events that satisfy the \met trigger requirement and have at least four jets, at least three $b$-jets and $\met>200$ GeV, 
...
Thanks to the fact that the same selection on the number of $b$-jets is adopted in the \gls{cr}, \gls{sr} and \glspl{vr} of the same type, 
