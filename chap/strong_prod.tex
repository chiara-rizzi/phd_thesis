...
\begin{description}
\item[Gtt-1L] A first optimization targets the Gtt signals (shown in Fig. \ref{fig:diagram_Gtt}) in the final states with at least one reconstructed 
lepton.
...
The \glspl{sr} are define as the regions that maximize the expected significance for each benchmark model while fulfilling these requirements:
\begin{itemize}
