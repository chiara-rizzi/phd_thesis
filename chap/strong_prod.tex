...
In the case of the Gtt-0L regions, the main extrapolation between \gls{cr} and \gls{sr}
...
Figures \ref{fig:Gtt_1L_tt}, \ref{fig:Gtt_0L_tt} \ref{fig:Gbb_tt} show the decay type of the \ttbar background for  Gtt-1L, Gtt-0L and Gbb regions respectively.
...
this is because both these types of regions have an upper cut on \mt.
Instead the SRs and the validation regions that check the \mt extrapolation occupy a phase space at high-\mt;
this selection suppresses single-lepton \ttbar and therefore the SRs and VRs-\mt
are dominated by dilepton \ttbar.

In the case of Figures \ref{fig:Gtt_0L_tt} and \ref{fig:Gbb_tt} we see all regions are dominated by single-lepton \ttbar.
In these cases, the CRs are 1-lepton regions with an upper cut on \mt and the SRs and VRs are 0-lepton regions,
