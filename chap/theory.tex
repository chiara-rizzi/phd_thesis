...
The phenomenological Minimal Supersymmetric Standard Model (pMSSM) reduces the number of free parameters in the MSSM through some general and experimentally motivated assumptions. In particular:
\begin{itemize}
\item 
\end{itemize}

The parameters of the pMSSM are summarized in Table \ref{tab:pMMSpar}.
