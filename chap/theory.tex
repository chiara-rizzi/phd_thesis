...
\caption{\subref{fig:sm:h_mass} Best fit values as a function of particle mass for the combination of ATLAS and CMS data. \subref{fig:sm:h_xsec} Best fit value of Higgs production cross section times branchng fraction in different production and decay modes. Figure from \cite{Khachatryan:2016vau}.}
