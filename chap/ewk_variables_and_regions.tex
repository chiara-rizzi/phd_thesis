...
\begin{figure*}[htbp]
\centering 
\subfigure[m($h_1$)]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_mass_h1_min_dR.pdf}\label{fig:ewk:sig:mass_h1_min_dR}}
\subfigure[m($h_2$)]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_mass_h2_min_dR.pdf}\label{fig:ewk:sig:mass_h2_min_dR}}
\subfigure[\dRmax]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_dRmax_dR.pdf}\label{fig:ewk:sig:dRmax_dR}}\\
\subfigure[\njet]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_jets_n.pdf}\label{fig:ewk:sig:jets_n}}
\subfigure[\nbjet]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_bjets_n.pdf}\label{fig:ewk:sig:bjets_n}}
\subfigure[\met]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_met.pdf}\label{fig:ewk:sig:met}}\\
\subfigure[\meffb]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_meff_4bj.pdf}\label{fig:ewk:sig:meff_4bj}}
\subfigure[\mtb]{\includegraphics[width=0.325\textwidth]{figures/ewk_prod/sig_bkg/hh_compare_mTb_min.pdf}\label{fig:ewk:sig:mTb_min}}
...
\meffb $>$ 1100 GeV, \mtb$>$130 GeV, \dRmax $<$ 1.4, \met $>$200, $\geq$ 3 b-jets (77\% WP), 
4-5 jets, m($h_1$) in 110-150 GeV, m($h_2$) in 90-140 GeV.
...
\begin{enumerate}
\item Optimize for one specific signal benchmark: 300, 500 GeV respectively for the 600-850 and 850-1100 GeV \meffb bins.
\item  Where possible with a loss in significance $<$ 15\%, the selections are made uniform. 
This results to be the case for the m(h1) and m(h2) ranges, for the selection in \met, for the first bin in \dRmax, 
...
and allowing an easier re-interpretation of the results.

The upper selection on \meffb, that makes the different \glspl{sr} orthogonal, 
limits the most the sensitivity of the individual \glspl{sr}.
...
and SR-3b-meff3 (orange and green line respectively in the figure) allow us to have good expected sensitivity for the entire mass spectrum. 
...
distribution of the number of b-jets is improved, as can be appreciated comparing Figure \ref{fig:strong:datamc0L:bjets_n} with Figure \ref{fig:ewk:datamc:bjets_n}.
...
As show in Figure \ref{fig:ewk:datamc_a}, all the variables specific to this analysis show a good 
agreement between data and the \gls{mc} simulation. 

\begin{figure*}[htbp]
\centering 
%\subfigure[\njet]{\includegraphics[width=0.45\textwidth]{figures/ewk_prod/data_mc/0L_3bin/data_mc_jets_n.pdf}
%\label{fig:ewk:datamc:jets_n}}
\subfigure[\nbjet]{\includegraphics[width=0.45\textwidth]{figures/ewk_prod/data_mc/0L_3bin/data_mc_bjets_n.pdf}
...
\caption{Data-MC comparison in the preselection, described in the text.
}
