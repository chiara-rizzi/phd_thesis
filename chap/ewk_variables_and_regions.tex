...
more collimated decay products. Signal events also tend to have a lower number of signal jets, as it can be observed in Figure 
...
distribution of the number of $b$-jets is improved, as it can be appreciated comparing Figure \ref{fig:strong:datamc0L:bjets_n} with Figure \ref{fig:ewk:datamc_bjets}.
...
As it can be observed in Figure \ref{fig:ewk:datamc_a}, all the variables specific to this analysis show a good 
