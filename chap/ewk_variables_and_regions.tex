...
The analysis strategy described above leads to a good sensitivity for exclusion across the entire mass spectrum, 
...
In the exclusion fit this is not a problem, as the sensitivity lost in one bin is reovered in the neighbouring one. 
...
Using only the modified versions of SR-4b-meff1-A and SR-3b-meff3 (orange and green line respectively in the figure) allow us to have good expected sensitivity for the entire mass spectrum. 
