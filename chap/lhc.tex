...
The summary of the LHC operational parameters during Run2 is reported in Table \ref{tab:lhc:param}.
...
$\mu = \frac{L_{bunch}\times \sigma_{inel}}{f}$, where $L_{bunch}$ is the per bunch instantaneous luminosity, $\sigma_{inel}$ is the inelastic cross section which is taken to be 80 mb for 13 TeV collisions, and $f$ is the LHC revolution frequency. Figure from Ref. \cite{LumiTwiki}.}
\label{fig:atlas:pu}
\end{figure}
