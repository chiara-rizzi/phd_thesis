...
\begin{figure}[ht]
\centering
\subfigure{\includegraphics[width=0.49\textwidth]{figures/atlas/lumi/pu_profile_run1}\label{fig:atlas:pu:run1}}
\subfigure{\includegraphics[width=0.49\textwidth]{figures/atlas/lumi/pu_profile}\label{fig:atlas:pu:run2}}
...
The accelerator complex of \gls{cern} is shown in Figure \ref{fig:lhc:acc}. The acceleration chain for lead ions is the same, except that the extraction and first acceleration is performed by Linac3 instead than by Linac2.
