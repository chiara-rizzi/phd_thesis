...
\begin{center}
  \subfigure[]{
    ...
    \includegraphics[width=0.43\textwidth]{figures/simul/Figures_MonteCarlo_string_had}
  }
    \subfigure[]{
    \label{fig:cluster_model}
    \includegraphics[width=0.43\textwidth]{figures/simul/Figures_MonteCarlo_clustr_had}
  }
\end{center}
