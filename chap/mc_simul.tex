...
\begin{description}
\item[Pythia] \cite{Sjostrand:2006za,Sjostrand:2014zea} Pythia is a general purpose generator that uses \gls{lo} matrix elements for $2\rightarrow n $ ($n \leq 3$) processes; 
...
\item[Herwig] \cite{Corcella:2000bw,Bahr:2008pv,Bellm:2015jjp} It computes $2\rightarrow 2$ \gls{lo} matrix elements.
