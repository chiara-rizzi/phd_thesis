...
\begin{figure*}[htbp]
	\centering
\subfigure{\includegraphics[width=0.48\textwidth]{figures/springer/BR_higgsino_tanb20-0_eta1-0.pdf}}
\subfigure{\includegraphics[width=0.48\textwidth]{figures/springer/BR_higgsino_tanb20-0_eta-1-0.pdf}}
\subfigure{\includegraphics[width=0.48\textwidth]{figures/springer/BR_higgsino_tanb1-5_eta1-0.pdf}}
\subfigure{\includegraphics[width=0.48\textwidth]{figures/springer/BR_higgsino_tanb1-5_eta-1-0.pdf}}
\caption{Branching ratios of the higgsino NLSP to a photon, a $Z$ boson, and a Higgs boson, as a function of $m_{NLSP}$, for $\eta=\pm1$ and $\tan\beta=1.5,\,20$. In all the figures, $M_1=500$ GeV, $M_2=1000$ GeV, and $m_{h^0}=125$ GeV. The figures are obtained following the formulas in Ref. \cite{Meade:2009qv}.}
