...
In \gls{rpc} models the \gls{lsp} is stable and, if it is neutral (as in the case of a \ninoone \gls{lsp} 
...
$\ninoone \rightarro t b s$, and large values  of $\lambda''_{323}$ can also lead to the 
