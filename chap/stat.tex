...
\subref{fig:stat:example2} The arrows indicate the definition of the \glspl{sr}; the one named "SR" is the region that maximizes the expected significance, while SR1 and SR2 are the orthogonal bins in which SR is divided.
}
\label{fig:stat:example}
\end{figure}
