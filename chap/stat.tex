...
\begin{itemize}
\item First of all, the usage of a \gls{cr} allows to eliminate mismodellings in the normalization of the background sample in a phase space 
