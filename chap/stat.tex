...
The maximum likelihood estimate of the parameters $\theta_i$ is obtained by choosing the set of parameters that yields the global maximum of the likelihood function. 
