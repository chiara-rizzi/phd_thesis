...
This strategy avoids the discontinuity for $\theta=0$, but it can introduce problems with the sign of the variation, for example sign inversion if $b-b^+$ and $b-b^-$ have the same sign.
...
\begin{figure}[h]
\centering 
\subfigure[]{\includegraphics[width=0.36\textwidth]{figures/stat/interp_1.pdf}\label{fig:interp_1}}
\subfigure[]{\includegraphics[width=0.36\textwidth]{figures/stat/interp_2.pdf}\label{fig:interp_2}}
\subfigure[]{\includegraphics[width=0.36\textwidth]{figures/stat/interp_3.pdf}\label{fig:interp_3}}
\subfigure[]{\includegraphics[width=0.36\textwidth]{figures/stat/interp_4.pdf}\label{fig:interp_4}}
