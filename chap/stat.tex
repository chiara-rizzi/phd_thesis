...
\begin{figure}[h]
\centering 
\subfigure[VR pre-fit]{\includegraphics[width=0.48\textwidth]{figures/stat/examples/cls_distribution_Signal_Freq_CLs_grid_ts3.pdf}\label{fig:stat:CLscan:toys}}
