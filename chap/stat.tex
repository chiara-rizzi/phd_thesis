...
In this example, the following event yields are attributed to a common systematic uncertainty fully correlated across regions:
\begin{description}
\item[CR] Nominal: 5775.6, up variation: 6930.7, down variation: 4620.5 (a 20\% up and down variation).
\item[VR] Nominal: 83.8, up variation: 125.7, down variation: 41.9 (a 50\% up and down variation).
\end{description}

\noindent While the pre-fit uncertainty on the \gls{vr} is large, the variation of the transfer factor is smaller:
\begin{equation}
\begin{split}
TF^{nominal}_{VR} &= \frac{83.8}{5775.6} = 0.0145 \\
TF^{up}_{VR} &= \frac{125.7}{6930.7} = 0.0181 \\
TF^{down}_{VR} &= \frac{41.9}{4620.5} = 0.0091 \\
\end{split}
\end{equation}
...
\begin{figure}[h]
\centering 
\subfigure[VR pre-fit]{\includegraphics[width=0.4\textwidth]{figures/stat/examples/VR_cuts_beforeFit.pdf}\label{fig:stat:VRprefit}}
\subfigure[VR post-fit]{\includegraphics[width=0.4\textwidth]{figures/stat/examples/VR_cuts_afterFit.pdf}\label{fig:stat:VRpostfit}}\caption{
