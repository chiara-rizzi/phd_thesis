...
\begin{center}
  ...
  \subfigure[]{
    ...
    \includegraphics[width=0.51\textwidth]{figures/objects/jvt_data.pdf}
  }
\end{center}
...
\begin{center}
  %\subfigure[]{
  %  \label{fig:obj:ttSF}
    \includegraphics[width=0.48\textwidth]{figures/objects/cjettt_77SF.pdf}  %}
  %\subfigure[]{
   % \label{fig:obj:mv2_b}
    %\includegraphics[width=0.48\textwidth]{figures/objects/mv2c10_b.pdf} }
\end{center}
...
\begin{center}
  \subfigure[]{
    ...
    \includegraphics[width=0.48\textwidth]{figures/objects/mistag_fig_05c.pdf}  }
  \subfigure[]{
    \label{fig:obj:mistag2}
    \includegraphics[width=0.48\textwidth]{figures/objects/mistag_fig_05d.pdf} }
\end{center}
