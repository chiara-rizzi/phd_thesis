...
All the selection in the definition of the objects described in Section \ref{sec:common_obj_def} result into a systematic uncertainty on the modelling of that selection in 
