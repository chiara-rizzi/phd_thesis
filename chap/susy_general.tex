...
\noindent In addition to multiplicity variables, we can also use the energy of the individual objects as a discriminating variable; for example we can consider only jets with \pt above a certain threshold if we expect high-\pt jets from our signal. 
