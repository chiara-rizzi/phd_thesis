...
Another variable useful to suppress the \ttbar background is the transverse mass between \met and the $b$-jets in the event:
...
A different weight is computed for each b-tagging requirement, e.g. the probability for the event to have at least three b-tagged jets will be different form the probability of having exactly two. 
...
\subref{fig:Z_met_0L_ren} Comparison of nominal and renormalization uncertainties.
\subref{fig:Z_met_0L_fac} Comparison of nominal and factorization uncertainties.
\subref{fig:Z_met_0L_match} Comparison of nominal and matching uncertainties.
\subref{fig:Z_met_0L_res} Comparison of nominal and resummation uncertainties.
...
\caption{Distribution normalized to unity of the \pt of the leading signal jet in the Z+jets \gls{mc} sample in a selection requiring at least four jets, at least two $b$-jets, $\met>200$ GeV and exactly zero lepton. 
\subref{fig:W_met_0L_ren} Comparison of nominal and renormalization uncertainties.
\subref{fig:W_met_0L_fac} Comparison of nominal and factorization uncertainties.
\subref{fig:W_met_0L_match} Comparison of nominal and matching uncertainties.
\subref{fig:W_met_0L_res} Comparison of nominal and resummation uncertainties.
...
\caption{Example Feynman diagram for single multijet production. \subref{fig:qcd_prod_1}-\subref{fig:qcd_prod_2} \gls{lo} $2 \to 2$ process. 
...
\caption{Distribution of \met in \subref{fig:jet_smear_met_CR} the region with $\dphimin < 0.1$ where the data-driven estimate for the multijet backgorund is normalized and \subref{fig:jet_smear_met_VR1} the multijet validation region with $0.1 < \dphimin < 0.2$}\label{fig:jet_smear_met}
\end{figure}
...
\caption{Distribution of the number of signal jets in \subref{fig:jet_smear_jetn_CR} the region with $\dphimin < 0.1$ where the data-driven estimate for the multijet backgorund is normalized and \subref{fig:jet_smear_jetn_VR1} the multijet validation region with $0.1 < \dphimin < 0.2$}\label{fig:jet_smear_jetn}
\end{figure} 
