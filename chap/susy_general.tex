...
as this is the endpoint that is obtained when \met originating from the neutrino is perfectly measured and the \textit{b}-jet produced in the decay of the same top quark as the neutrino is among the three leading \textit{b}-tagged jets. 
...
%}
\caption{Example schema to choose the selected permutation with truth \textit{b}-tagging.}\label{fig:susy_common_trf_perm}
\end{figure}
