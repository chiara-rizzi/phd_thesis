...
The flavour of the jets is determined by matching them with the $B$- and $D$-hadrons that are in a cone of $\Delta R = 0.4$ from the jet. 
...
Single top events produced through the t-channel process are simulated with \PowhegBox v1, which uses the four-flavour scheme for the computation of the \gls{nlo} \gls{me} and the CT10f4 \gls{partdf} set, with the four-flavour scheme as well, and the top quarks are decayed with \MadSpin \cite{Artoisenet:2012st}.
...
and the associated neutrino (to produce some \met) and the $b$-tagging requirement is satisfied because of the production of extra heavy-flavour jets, or because the jet form the hadronic decay of the $\tau$
...
heavy-flavour jets or jets that are mistagged; these events contribute almost exclusively to the analysis regions with a lepton veto. 
