...
\caption{Example Feynman diagram for single multi-jet production. \subref{fig:qcd_prod_1}-\subref{fig:qcd_prod_2} $2 \to 2$ process. 
\subref{fig:qcd_prod_3}}\label{fig:qcd_prod}
\end{figure}
