...
\item[Parton Shower and Hadronization] Also the choice of the generator that emulates the \gls{psh} and the hadrinization is associated to an uncertainty, that is evaluated by comparing 
\item[ISR/FSR]
\end{description}
