...
The \gls{lhc} Run 2 will continue providing $pp$ collisions until autumn 2018; 
...
nominal luminosity. 
This will allow \gls{atlas} to record a total of about 300 \ifb of data to be analyzed 
to answer questions on the physics beyond the \gls{sm}. 
